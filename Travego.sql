...
SELECT Gender, COUNT(*) AS PassengerCount FROM Passenger WHERE Distance >= 600 GROUP BY Gender;
SELECT MIN(Price) AS MinimumTicketPrice FROM Price WHERE Bus_type = 'Sleeper';
